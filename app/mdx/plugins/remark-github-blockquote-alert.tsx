...
export const remarkAlert: Plugin<[Option?], Root> = ({
  ...
  return (tree) => {
    visit(tree, "blockquote", (node, index, parent) => {
      ...
      if (alertType) {
        // Create title paragraph as MDX JSX element with proper typing
        const titleParagraph: MdxJsxFlowElement = {
        ...
        const alertElement: MdxJsxFlowElement = {
          type: "mdxJsxFlowElement",
          name: tagName,
          attributes: [
            {
              type: "mdxJsxAttribute",
              name: "className",
              value: `not-prose markdown-alert markdown-alert-${alertType}`,
            },
            {
              type: "mdxJsxAttribute",
              name: "dir",
...
export function getAlertIcon(type: IconType): MdxJsxTextElement {
  const pathD = pathData[type] ?? "";
  return {
    type: "mdxJsxTextElement",
    name: "svg",
    attributes: [
      { type: "mdxJsxAttribute", name: "className", value: "octicon" },
      { type: "mdxJsxAttribute", name: "viewBox", value: "0 0 16 16" },
    ...
    children: [
      {
        type: "mdxJsxTextElement",
        name: "path",
        attributes: [{ type: "mdxJsxAttribute", name: "d", value: pathD }],
        children: [],
      },
    ],
  };
