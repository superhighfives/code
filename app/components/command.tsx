...
export default function Command({
  ...
  return (
    <div className="relative border border-b-4 p-4 pr-16 rounded-xs bg-gray-50 dark:bg-gray-950 border-gray-200 dark:border-gray-700 mt-4 break-words [&>pre>code]:whitespace-pre-wrap">
      <button
        type="button"
        onClick={handleCopy}
